...
<html>
    ...
    <body>
        ...
        <div class="para2">
            In here we write some simple code for get something as output.    
        </div>
        
        <div class="para4">
            Watch the following video to grab more knowledge. And you can practice doing some problems which we are already provided.
        </div>
        <video class="tutorial" src="Resources\HelloWorld.mp4" width="1280" type="video/mp4" controls></video>
